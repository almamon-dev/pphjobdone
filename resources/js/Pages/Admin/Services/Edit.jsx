                        ...
                        <div className="bg-white rounded-[10px] border border-[#e3e4e8] shadow-sm p-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {data.pricing_plans.map((plan, pIndex) => (
                                    <div
                                        key={pIndex}
                                        className="p-4 bg-[#f8f9fc] rounded-lg border border-[#e3e4e8] space-y-4"
                                    >
                                        <div className="flex justify-between items-start">
                                            <h3 className="text-[13px] font-bold text-[#673ab7] uppercase tracking-wider">
                                                Plan {pIndex + 1}
                                            </h3>
                                        ...
                                        <div className="grid grid-cols-1 gap-3">
                                            <div className="space-y-1">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full h-[40px] px-3 border border-[#e3e4e8] rounded-lg outline-none text-[13px]"
                                                />
                                            </div>
                                            <div className="space-y-1">
                                                <label className="text-[12px] font-bold text-[#727586]">
