...
export default function Edit({ recipe, categories }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        status: recipe.status ? true : false,
        _method: "PUT",
    });
                                        ...
                                        <div className="relative w-full h-[200px] rounded-xl overflow-hidden border border-[#e3e4e8]">
                                            ...
                                            <div className="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                                <button
                                                    type="button"
                                                    onClick={removeImage}
                                                    className="w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 transition-all"
                                                >
                                                    <Trash2 size={18} />
                                                </button>
                                                <label className="w-10 h-10 bg-white text-[#2f3344] rounded-full flex items-center justify-center hover:bg-gray-100 transition-all cursor-pointer">
                                                    <Upload size={18} />
                                                    <input
                                                        type="file"
                                                        onChange={
