...
export default function Edit({ category }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        _method: "PUT", // Used for file uploads with PUT in Laravel
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // We use POST with _method: PUT for file updates in Laravel/Inertia
                        ...
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-[13px] text-[#727586]">
                                    Modify the properties of your existing
                                    recipe category
                                </p>
                            </div>
                        </div>
